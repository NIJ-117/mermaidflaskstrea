...
def generateflowchart(state):
    ...
    """
    system = "You are mermaid flowchart generating machine which strictly follows this documentation "
    ...
    result=chain.invoke({"text": f"for following question {question} we have  answer as context {Context} now we have to make the flowchart for this answer in mermaid js using this documentation {flowchart_documentation}. try to use top to down in majority of uses and make detailed flowchart"})
